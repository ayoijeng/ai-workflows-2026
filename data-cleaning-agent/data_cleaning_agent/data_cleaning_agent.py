...
def make_lightweight_data_cleaning_agent(
    ...
    def create_data_cleaner_code(state: GraphState):
        ...
        data_cleaning_prompt = PromptTemplate(
            ...
            5. Standardize the data types of the columns
            6. Rename the columns to be more descriptive
            7. Clean text columns by removing special characters and converting to lowercase
            8. Clean categorical columns by converting to lowercase and standardizing the values
            9. Clean numeric columns by converting to float and standardizing the values
            10. Clean boolean columns by converting to boolean and standardizing the values
            11. Clean object columns by converting to string and standardizing the values
            12. Clean category columns by converting to string and standardizing the values
            13. Clean datetime columns by converting to datetime and standardizing the format
            ...
            Important:
            - Only use pandas, numpy, scipy, and sklearn (no other third-party imports).
